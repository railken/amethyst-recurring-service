...
abstract class RecurringServiceException extends Exception implements ExceptionContract
{
    /**
     ...
     * @var string
     */
    protected $label = 'recurring_service';
     ...
     * @var string
     */
    protected $code = 'RECURRINGSERVICE_ERROR';
